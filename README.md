...
8. `feat: add clients and demands pages structure`
9. `docs: document backend rules and frontend-backend API integration`
10. `feat: implement clients API endpoints`
11. `feat: implement demands API endpoints`
12. `feat: implement kanban status update flow`
13. `feat: implement monthly client report endpoint`
14. `feat: add monthly client report page`
